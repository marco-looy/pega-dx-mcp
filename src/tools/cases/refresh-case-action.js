    ...
    return {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          pageInstructions: {
            type: 'array',
            description: 'List of page-related operations to be performed on embedded pages, page lists, or page group properties included in the case action\'s view during the refresh. These operations allow manipulation of complex data structures within the case. Each instruction specifies the operation type and target page structure. Only pages included in the case action\'s view can be modified.',
            items: {
              type: 'object'
            }
          },
